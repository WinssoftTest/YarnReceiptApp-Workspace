...
import { MatAutocompleteModule, MatCheckboxModule,
...
export class LoginPage implements OnInit {
 ...
 count = localStorage.getItem('count')
  ...
  ngAfterViewInit(): void {
    console.log('noworkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk')
     this.CompanyNameLoad();
   }
  ngOnInit() {
    console.log('jg')
...
public CompanyNameLoad()
  ...
  Login()
  {
    if(this.loginForm.value.CompanyName == null || this.loginForm.value.CompanyName == undefined || this.loginForm.value.CompanyName == '0')
    {
     this.commonprovider.FailedToast('Select CompanyName')
    }
