...
itemClick(d: any, index: any) {
  ...
  console.log('Grid',this.GridDetailsLoad)
   ...
   {
     this.orderqty  = this.Selectedlistarr[i].OrderQty;
     this.Received= this.Selectedlistarr[i].Received
     ;
   }

   if(this.Mtr >  Number(this.orderqty -  this.Received))
   {
    alert('Qty Exceeds')
    this.Mtr="";
   }
   else if(this.BaleNo == "" || this.BaleNo == undefined || this.BaleNo == null)
   {
         this.commonprovider.FailedToast('Type Bale No')
   }
   else if(this.Mtr  == "" || this.Mtr == undefined || this.Mtr == null)
   {
     this.commonprovider.FailedToast('Type Mtr')
   }
  else{
